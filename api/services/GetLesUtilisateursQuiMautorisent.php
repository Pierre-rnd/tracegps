<?php
// Rôle : ce service web permet à un utilisateur d'obtenir la liste des utilisateurs qui l'autorisent à consulter 
// leurs parcours.
...
// • Fournir la liste des utilisateurs qui l'autorisent à consulter leurs parcours.
